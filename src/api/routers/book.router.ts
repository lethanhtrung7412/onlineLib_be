        ...
        router.post(
            ...
            async(req, res) => {
                try {
                    ...
                    newBook.category =await categoryHandler.getSpecificCategories(Number(req.body.category));
        ...
        router.put(
            ...
            async(req, res) => {
                try {
                    ...
                    const updateCategory = await categoryHandler.getSpecificCategories(Number(req.body.category))
                    const updatedBook = {
                        ...req.body,
